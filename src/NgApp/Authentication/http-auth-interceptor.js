 ...
 * License: MIT
 * Modifications (c) 2014 Lotpath, Inc.
 */
(function() {
    'use strict';
        ...
        .factory('authInterceptor', ['$rootScope', 'httpBuffer', function($rootScope, httpBuffer) {
            return {
                ...
                */
                ...
                /**
                * Call this function to publish the loginRequired event
                * This prevents making call that we know will get a 401 due to a missing token
                * @param data an optional argument to pass on to $broadcast.
                */
